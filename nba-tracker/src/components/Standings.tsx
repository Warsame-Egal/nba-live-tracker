      ...
      return (
        ...
        >
          <Box>
            ...
            <Box sx={{ display: { xs: 'block', sm: 'none' }, minHeight: 400 }}>
              {eastStandings.map(team => renderStandingCard(team, true))}
            </Box>
            <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
              {renderTable(eastStandings, true)}
            </Box>
          </Box>
          <Box>
            <Typography
            ...
            <Box sx={{ display: { xs: 'block', sm: 'none' }, minHeight: 400 }}>
              {westStandings.map(team => renderStandingCard(team, true))}
            </Box>
            <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
              {renderTable(westStandings, true)}
            </Box>
          </Box>
        </Box>
      );
        ...
        {confDivisions.map(div => {
          ...
          return (
            <Box key={div} sx={{ mb: { xs: 2, sm: 3 }, minHeight: { xs: 200, sm: 250 } }}>
              ...
              {/* Desktop Table View */}
              <Box sx={{ display: { xs: 'none', sm: 'block' } }}>{renderTable(teams, false)}</Box>
            </Box>
          );
        })}
      </Box>
