...
import { Card, Typography, Box, Avatar, Chip, LinearProgress, Tooltip } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {winProbability !== null && (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Typography
              variant="caption"
              sx={{ color: 'text.secondary', fontWeight: typography.weight.semibold }}
            >
              {winProbability}%
            </Typography>
            <LinearProgress
      ...
      {gameLeaders && (gameLeaders.homeLeaders || gameLeaders.awayLeaders) && (
        ...
        >
          {gameLeaders.awayLeaders && <LeaderPreview leader={gameLeaders.awayLeaders} />}
          {gameLeaders.homeLeaders && <LeaderPreview leader={gameLeaders.homeLeaders} />}
        </Box>
      )}
      ...
      >
        <Avatar
          ...
          sx={{
            ...
            boxShadow: teamColor
              ? shadows.sm.replace('rgba(0, 0, 0, 0.1)', `${teamColor}40`)
              : 'none',
            transition: transitions.normal,
            '&:hover': {
