...
interface PredictionHeaderProps {
  ...
  /** When true, do not render the confidence badge (e.g. when card shows it top-right). */
 ...
 */
const PredictionHeader: React.FC<PredictionHeaderProps> = ({ prediction, hideConfidence }) => {
  ...
  return (
    ...
    >
      ...
      {/* Confidence badge (hidden when card shows it top-right) */}
      {!hideConfidence && prediction.confidence_tier && confidenceColor && (
        <Chip
          label={
