 ...
 */
const WinProbabilityTracker: React.FC<WinProbabilityTrackerProps> = ({
  games,
  winProbabilities,
}) => {
    ...
    >
      ...
      {liveGames.length === 0 ? (
        ...
        >
          ...
          >
            No live games at the moment. Win probability will appear here when games are in
            progress.
          </Typography>
        </Box>
      ) : (
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    {homeTeam.teamTricode} {homeTeam.score} - {awayTeam.score}{' '}
