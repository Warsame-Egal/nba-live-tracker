      ...
      <Card variant="outlined" sx={{ backgroundColor: cardBg }}>
        <CardContent sx={{ p: responsiveSpacing.card }}>
          ...
          <Typography color="text.secondary">
            AI scouting report is unavailable. This may be due to rate limits or missing API
            configuration.
          </Typography>
          {onRefresh && (
            <Button startIcon={<Refresh />} onClick={onRefresh} size="small" sx={{ mt: 1 }}>
              Try again
            </Button>
          )}
        </CardContent>
    ...
    <Card variant="outlined" sx={{ backgroundColor: cardBg }}>
      <CardContent sx={{ p: responsiveSpacing.card }}>
        ...
        <Typography
          ...
          sx={{ display: 'block', mt: 2, pt: 1, borderTop: '1px solid', borderColor: 'divider' }}
        >
          Generated by Groq
        </Typography>
      </CardContent>
