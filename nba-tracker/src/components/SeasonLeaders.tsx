...
const SeasonLeaders: React.FC<SeasonLeadersProps> = ({ data }) => {
  ...
  const isPercentageCategory = (categoryName: string): boolean => {
    return (
      categoryName.toLowerCase().includes('percentage') ||
      categoryName.toLowerCase().includes('pct')
    );
  };
  ...
  const isWholeNumberCategory = (categoryName: string): boolean => {
    return (
      categoryName.toLowerCase().includes('made') || categoryName.toLowerCase().includes('total')
    );
  };
