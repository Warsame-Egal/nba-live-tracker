...
import { Close, ArrowBack, Assessment, Timeline, OpenInNew } from '@mui/icons-material';
...
const GameDetailsDrawer = ({
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars -- reserved for future styling
      ...
      {team.players.length > 0 ? (
        ...
        >
          ...
          >
            <Typography
              variant="caption"
              sx={{ fontWeight: 700, minWidth: 120, color: 'text.secondary' }}
            >
              PLAYER
            </Typography>
            <Typography
              variant="caption"
              sx={{ fontWeight: 700, minWidth: 50, textAlign: 'center', color: 'text.secondary' }}
            >
              MIN
            </Typography>
            <Typography
            ...
            {team.players.map((p: PlayerBoxScoreStats, idx) => (
              ...
              >
                ...
                >
                  <Typography
                    variant="body2"
                    sx={{ minWidth: 50, textAlign: 'center', color: 'text.secondary' }}
                  >
        ...
        >
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              {gameId && (
                ...
                >
                  <OpenInNew sx={{ fontSize: 18 }} /> Open full page
                </Link>
              )}
            </Box>
            <IconButton
          ...
          {gameInfo && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
              ...
              />
              <Typography variant="body2" color="text.secondary">
                {gameInfo.awayTeam} {gameInfo.awayScore ?? 0} - {gameInfo.homeScore ?? 0}{' '}
                {gameInfo.homeTeam}
              </Typography>
            </Box>
          )}
              ...
              isLiveGame={
                gameInfo?.status
                  ? gameInfo.status.toLowerCase().includes('live') ||
                    ...
                    (/\b[1-4]q\b/i.test(gameInfo.status) &&
                      !gameInfo.status.toLowerCase().includes('final'))
                  : false
              }
            />
          ) : (
