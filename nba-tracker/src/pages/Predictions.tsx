                  ...
                  >
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 0.5 }}>
                        {cachedPredictions.length} game{cachedPredictions.length !== 1 ? 's' : ''}{' '}
                        today
                      </Typography>
                      {cachedPredictions.length > 0 && (() => {
                        ...
                        return (
                          <>
                            ...
                            <Typography variant="caption" color="text.secondary" display="block">
                              Most confident: {getTeamAbbreviation(mostConfident?.away_team_name ?? '')}–
                              {getTeamAbbreviation(mostConfident?.home_team_name ?? '')} (
                              {(Math.max(mostConfident?.home_win_probability ?? 0, mostConfident?.away_win_probability ?? 0) * 100).toFixed(0)}%)
                            </Typography>
                          </>
                        );
                      })()}
