...
class PlayerBoxScoreStats(BaseModel):
    ...
    # Optional fields from NBA API for full game score and TS%
    ...
    free_throws_made: Optional[int] = Field(None, ge=0, description="Free throws made.")
    free_throws_attempted: Optional[int] = Field(None, ge=0, description="Free throws attempted.")
    rebounds_offensive: Optional[int] = Field(None, ge=0, description="Offensive rebounds.")
    rebounds_defensive: Optional[int] = Field(None, ge=0, description="Defensive rebounds.")
    fouls_personal: Optional[int] = Field(None, ge=0, description="Personal fouls.")
