...
@router.get("/teams/{team_id}", response_model=TeamDetailsResponse,
            summary="Get Team Details", tags=["teams"],
...
@router.get("/teams/search/{search_term}", response_model=List[TeamSummary],
            summary="Search Teams", tags=["teams"],
